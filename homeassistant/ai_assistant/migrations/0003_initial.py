...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ai_assistant', '0002_remove_message_conversation_delete_conversation_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['-created_at'], name='ai_assistan_created_6fb407_idx'), models.Index(fields=['conversation_id'], name='ai_assistan_convers_092552_idx')],
            },
        ),
        migrations.CreateModel(
            name='Message',
            fields=[
                ('message_id', models.CharField(db_index=True, max_length=255, primary_key=True, serialize=False)),
                ('role', models.TextField()),
                ('text_format', models.TextField(default='plain')),
                ('text', models.TextField()),
                ('metadata_json', models.JSONField(blank=True, null=True)),
                ('created_at', models.DateTimeField(db_index=True, default=django.utils.timezone.now)),
                ('previous_message_id', models.CharField(blank=True, max_length=255, null=True)),
            ...
            options={
                ...
                'ordering': ['created_at'],
                'indexes': [models.Index(fields=['conversation', 'created_at'], name='ai_assistan_convers_8f1a44_idx'), models.Index(fields=['message_id'], name='ai_assistan_message_81e6f0_idx'), models.Index(fields=['role'], name='ai_assistan_role_804f57_idx'), models.Index(fields=['-created_at'], name='ai_assistan_created_31802c_idx')],
            },
        ),
    ]

...
class LightDeviceAdmin(admin.ModelAdmin):
    list_display = ('name', 'device_type', 'ip_address', 'room', 'is_active', 'created_at')
...
class LightStateAdmin(admin.ModelAdmin):
    list_display = ('device', 'is_on', 'brightness', 'color_temp', 'rgb_color', 'last_updated')

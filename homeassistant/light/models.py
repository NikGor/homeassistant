...
class LightDevice(models.Model):
    ...
    device_type = models.CharField(max_length=20, choices=DEVICE_TYPES, default='yeelight', verbose_name="Тип устройства")
...
class LightState(models.Model):
    device = models.OneToOneField(LightDevice, on_delete=models.CASCADE, related_name='state')
    ...
    rgb_color = models.CharField(max_length=7, default="#FFFFFF", verbose_name="RGB цвет")
...
class LightGroup(models.Model):
    ...
    devices = models.ManyToManyField(LightDevice, related_name='groups', verbose_name="Устройства")
    room = models.CharField(max_length=50, blank=True, verbose_name="Комната")
    created_at = models.DateTimeField(auto_now_add=True)
...
class LightSchedule(models.Model):
    ...
    device = models.ForeignKey(LightDevice, on_delete=models.CASCADE, null=True, blank=True, verbose_name="Устройство")
    group = models.ForeignKey(LightGroup, on_delete=models.CASCADE, null=True, blank=True, verbose_name="Группа")
